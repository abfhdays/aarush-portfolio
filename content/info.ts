export const personalInfo = {
  ...
  bio: {
    ...
    work: [
      { text: "Crafting AI agents with NLP pipelines on a Pytorch & Neo4j stack for quantum-secure enterprise solutions @ ", company: "Qorsa", url: "https://qorsa.com" },
      { text: "Building RAG applications for UI/UX analytics on Databricks @ ", company: "CGI", url: "https://www.cgi.com" },
      { text: "Developing data pipelines for student tuition models with Spark and Kafka @ ", company: "UW", url: "https://uwaterloo.ca/math/" }
